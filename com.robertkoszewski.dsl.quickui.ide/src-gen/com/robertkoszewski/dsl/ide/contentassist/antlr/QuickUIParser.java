		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getConditionBranchAccess().getGroup_1(), "rule__ConditionBranch__Group_1__0");
					put(grammarAccess.getConditionConcatenationAccess().getGroup(), "rule__ConditionConcatenation__Group__0");
					put(grammarAccess.getConditionConcatenationAccess().getGroup_1(), "rule__ConditionConcatenation__Group_1__0");
					...
					put(grammarAccess.getConditionBranchAccess().getRightAssignment_1_2(), "rule__ConditionBranch__RightAssignment_1_2");
					put(grammarAccess.getConditionConcatenationAccess().getRightAssignment_1_2(), "rule__ConditionConcatenation__RightAssignment_1_2");
